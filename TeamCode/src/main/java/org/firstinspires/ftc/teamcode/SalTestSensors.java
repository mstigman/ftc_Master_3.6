...
@TeleOp(name="SalTestSensors", group="Linear Opmode")  // @Autonomous(...) is the other common choice
@Disabled
public class SalTestSensors extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        telemetry.addData("Status", "Gyro Before Caliberation");
        ...
        telemetry.addData("starting", "caliberation");
        telemetry.update();

        //The Gyro needs calibrating. Wait for the gyro to calibrate and keep robot stable
        gyro.calibrate();
        timestamp = runtime.seconds();
        while(gyro.isCalibrating() && opModeIsActive() &&
                (runtime.seconds()-timestamp < 8.0))
        {
            Thread.sleep(50);
            idle();
            telemetry.addData("Calib time", "%3.1f sec",(runtime.seconds()-timestamp));
        }
